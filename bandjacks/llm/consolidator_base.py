...
class ConsolidatorBase:
    ...
    # Evidence extraction methods (moved from evidence_utils.py)

    @classmethod
    def find_sentence_boundaries(cls, text: str) -> List[Tuple[int, int]]:
        """
    ...
    @classmethod
    def calculate_line_refs(cls, text: str, start_pos: int, end_pos: int) -> List[int]:
        """
    ...
    def extract_sentence_evidence(
        ...
        sentences = cls.find_sentence_boundaries(text)
        ...
        if not sentences:
            ...
            return {
                ...
                "line_refs": cls.calculate_line_refs(text, start, end),
        ...
        if start_idx < len(sentences) and end_idx > start_idx:
            ...
            line_refs = cls.calculate_line_refs(text, evidence_start, evidence_end)
    ...
    def extract_sentence_for_line(
        ...
        return cls.extract_sentence_evidence(text, char_pos, context_sentences)
